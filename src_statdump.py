...
def parse_arguments():
    ...
    parser.add_argument('-g', metavar='global_stats', type=str, default="global_stats.tab", help='Global stats file.')
    parser.add_argument('-t', metavar='tr_stats', type=str, default="tr_stats.tab", help='Transcripts stats file.')
